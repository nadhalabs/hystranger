          ...
          <section className="flex flex-col justify-center">
            ...
            {!media.stream ? (
              <button
                ...
                className="mt-4 flex h-16 w-full items-center justify-center gap-3 rounded-2xl bg-neutral-950 px-8 text-base font-black text-white shadow-2xl transition hover:bg-neutral-800 active:scale-[0.99] disabled:cursor-wait disabled:opacity-60 dark:bg-white dark:text-neutral-950 dark:hover:bg-neutral-200"
              >
              ...
              <div className="mt-4 space-y-3.5">
                ...
                {media.isReady && (
                  <button
                    ...
                    className="flex h-16 w-full items-center justify-center gap-3 rounded-2xl bg-neutral-950 px-8 text-lg font-black text-white shadow-2xl transition hover:bg-neutral-800 active:scale-[0.99] focus:outline-none focus:ring-4 focus:ring-neutral-400/20 dark:bg-white dark:text-neutral-950 dark:hover:bg-neutral-200 dark:focus:ring-white/20"
                  >
